...
// lr_2_sopad.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clr_2_sopadApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Clr_2_sopadApp

Clr_2_sopadApp::Clr_2_sopadApp()
{
...
// Единственный объект Clr_2_sopadApp

Clr_2_sopadApp theApp;


// инициализация Clr_2_sopadApp

BOOL Clr_2_sopadApp::InitInstance()
{
